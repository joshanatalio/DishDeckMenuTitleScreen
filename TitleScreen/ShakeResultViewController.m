...
- (IBAction)EditPlateFromButton1:(UIButton *)sender {
    ...
    if(sender.selected == YES) {
        ...
        [self addToPlateQuery:@"achuang94" ItemName: self.AppetizerName.text];
        ...
        [self deletePlateItem:@"achuang94" ItemName: self.AppetizerName.text];
...
- (IBAction)EditPlateFromButton2:(UIButton *)sender {
    ...
    if(sender.selected == YES) {
        NSLog(@"button is selected!");
        [self addToPlateQuery:@"achuang94" ItemName: self.EntreeName.text];
        UIImage *selected = [UIImage imageNamed:@"AddToPlate.png"];
        [sender setImage:selected forState:UIControlStateNormal];
    }
    else {
        NSLog(@"button is deselected!");
        [self deletePlateItem:@"achuang94" ItemName: self.EntreeName.text];
        UIImage *unselected = [UIImage imageNamed:@"AddToPlateUnselect.png"];
        [sender setImage:unselected forState:UIControlStateNormal];
    }
}
...
- (IBAction)EditPlateFromButton3:(UIButton *)sender {
    ...
    if(sender.selected == YES) {
        NSLog(@"button is selected!");
        [self addToPlateQuery:@"achuang94" ItemName: self.DessertName.text];
        UIImage *selected = [UIImage imageNamed:@"AddToPlate.png"];
        [sender setImage:selected forState:UIControlStateNormal];
    }
    else {
        NSLog(@"button is deselected!");
        [self deletePlateItem:@"achuang94" ItemName: self.DessertName.text];
        UIImage *unselected = [UIImage imageNamed:@"AddToPlateUnselect.png"];
        [sender setImage:unselected forState:UIControlStateNormal];
    }
}
...
- (IBAction)EditPlateFromButton4:(UIButton *)sender {
    ...
    if(sender.selected == YES) {
        NSLog(@"button is selected!");
        [self addToPlateQuery:@"achuang94" ItemName: self.BeverageName.text];
        UIImage *selected = [UIImage imageNamed:@"AddToPlate.png"];
        [sender setImage:selected forState:UIControlStateNormal];
    }
    else {
        NSLog(@"button is deselected!");
        [self deletePlateItem:@"achuang94" ItemName: self.BeverageName.text];
        UIImage *unselected = [UIImage imageNamed:@"AddToPlateUnselect.png"];
        [sender setImage:unselected forState:UIControlStateNormal];
    }
}
